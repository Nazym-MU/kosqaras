        ...
        <div className="bg-light dark:bg-dark/20 rounded-xl overflow-hidden shadow-xl mb-12">
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            {category === 'animation' && artwork.videoUrl && (
              <div className="bg-accent/5 border border-accent/20 p-4 rounded-lg mb-8 text-foreground/80 text-sm flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-accent mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                <span>Click play to watch the animation.</span>
              </div>
            )}
