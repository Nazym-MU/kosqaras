            ...
            >
                ...
                >
                    <div className="flex justify-center space-x-8 mb-4">
                        <a href="https://instagram.com/https.kosqaras" target="_blank" rel="noopener noreferrer" className="text-white hover:text-accent transition-colors">
                        ...
                        <a href="mailto:ayanatkz@icloud.com" className="text-white hover:text-accent transition-colors">
